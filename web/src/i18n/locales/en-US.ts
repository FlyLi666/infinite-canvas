export default {
    ...
    settingsPanels: {
        ...
        model: {
            ...
            catalog: {
                gptImage2: { name: "GPT Image", hint: "Best at text and edits" },
                ...
                grokImagineImage20: { name: "GROK 2.0", hint: "Layout and edits; default GROK" },
                grokImagineEdit: { name: "GROK Legacy Edit", hint: "Old endpoint; use 2.0 to edit" },
                grokImagineVideo15: { name: "GROK Video", hint: "Official 1.5, up to 15s, with audio" },
                seedance20: { name: "Seedance 2.0", hint: "Short clips, familiar quality" },
                seedance25: { name: "Seedance 2.5", hint: "Longer, more references, 30s" },
