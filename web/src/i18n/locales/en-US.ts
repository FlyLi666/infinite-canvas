export default {
    meta: {
        title: "RIGEL Creative Canvas",
        description: "Yanlu image and video creation canvas",
    },
    ...
    common: {
        ...
        downloadRemoteOpened: "Opened in a new tab. A black screen means this network cannot reach the file.",
        upload: "Upload",
        requestCanceled: "Request canceled",
        durationMinutes: "{{minutes}}m {{seconds}}s",
        durationSeconds: "{{seconds}}s",
        imageReadFailed: "Failed to read image",
        localDataNotice: "Images, videos, and canvases stay in this browser only. Download anything you need to keep. Switching devices or clearing site data will delete local files and history.",
    },
    settingsPanels: {
        ...
        model: {
            ...
            addFirst: "Sign in to Yanlu AI first",
            capabilities: { image: "image generation", video: "video", text: "text", audio: "audio" },
            catalog: {
                gptImage2: { name: "GPT Image", hint: "$2.3/image · best at text and edits" },
                grokImagineImage: { name: "GROK Fast", hint: "Quick draft, not the finest" },
                grokImagineImageQuality: { name: "GROK Photo", hint: "More photoreal, no edits" },
                grokImagineImage20: { name: "GROK 2.0", hint: "1K $1.2 / 2K $2.2 · layout and edits" },
                grokImagineEdit: { name: "GROK Legacy Edit", hint: "Old endpoint; use 2.0 to edit" },
                grokImagineVideo15: { name: "GROK Video", hint: "Low $0.6 · Mid $0.8 · High $1.5 /sec · up to 15s" },
                seedance20: { name: "Seedance 2.0", hint: "Low $4.50 · Mid $9.90 · High $24.80 /sec" },
                seedance25: { name: "Seedance 2.5", hint: "Low $6.70 · Mid $15.10 · High $37.70 /sec · up to 30s" },
                grok46: { name: "GROK 4.6", hint: "Chat and reasoning, latest Grok" },
                gpt56Sol: { name: "Sol", hint: "Text writing, balanced" },
                gpt56Luna: { name: "Luna", hint: "Text writing, more creative" },
                gpt56Terra: { name: "Terra", hint: "Text writing, more restrained" },
            },
        },
    },
    generation: {
        pending: ["Creating image", "Almost there", "Just a little longer", "Refining details"],
        queuedAhead: "In queue · {{count}} images ahead",
        queuedNext: "In queue · you're next",
    ...
    auth: {
        ...
        subtitle: "Sign in to use Yanlu AI image generation without configuring any API key. Work stays in this browser only — download copies you need to keep.",
        login: "Sign in",
        account: "My account",
        email: "Email",
        ...
        submit: "Sign in",
        register: "Create a Yanlu AI account",
        forgotPassword: "Forgot password",
        totpHint: "Two-factor authentication is enabled for {{email}}. Enter the 6-digit code from your authenticator.",
        totpRequired: "Enter the 6-digit code",
        ...
        recharge: "Top up",
        logout: "Sign out",
        provisionFailed: "Failed to initialize the Yanlu AI service. Try again later.",
        turnstileRequired: "Complete the human verification first",
        turnstileLoadFailed: "Failed to load the verification widget. Check your network and retry.",
        errors: {
            network: "Network error. Check your connection and retry.",
            requestFailed: "Request failed. Try again later.",
            invalidCredentials: "Incorrect email or password",
            userNotActive: "This account is inactive or disabled",
            turnstileFailed: "Human verification failed. Try again.",
    ...
    assets: {
        title: "My Assets",
        description: "Save frequently used text and images, then find them quickly by type, title, or tag. Assets stay in this browser only — export or download anything you need to keep.",
    ...
    workbench: {
        ...
        untitled: "Untitled",
        configFirst: "Sign in and complete the configuration first",
    ...
    imageWorkbench: {
        ...
        generated: "Images generated. Download them now to keep a copy.",
    ...
    videoWorkbench: {
        ...
        generated: "Video generated. Download it now to keep a copy.",
    ...
    home: {
        ...
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>RIGEL</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    config: {
        ...
        description: "Yanlu AI service, default models, sync, and local storage",
        modalDescription: "Yanlu AI service, default models, sync, and local storage",
        tabs: {
            channels: "Providers",
        ...
        channels: {
            description: "After you sign in, Yanlu AI is used automatically. You do not need an endpoint or API key.",
            add: "Add provider",
            ...
            managedDescription: "Managed by your Yanlu AI account",
            signInHint: "Sign in to use image, video, and text generation. You do not add your own providers.",
        },
        preferences: {
            interface: "Interface",
        ...
        channelEditor: {
            ...
            name: "Provider name",
            protocol: "Protocol",
            managedHint: "This provider is managed by your Yanlu AI account. No endpoint or API key configuration is needed.",
