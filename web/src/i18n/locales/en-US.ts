export default {
    ...
    settingsPanels: {
        ...
        model: {
            ...
            catalog: {
                gptImage2: { name: "GPT Image 2", hint: "Rich detail, good for polished large images" },
                grokImagineImage: { name: "Grok Image", hint: "Fast and cost-effective" },
                grokImagineImageQuality: { name: "Grok High Quality", hint: "Dedicated high-fidelity model, finer detail" },
                grokImagineEdit: { name: "Grok Edit", hint: "Edit from a reference image" },
