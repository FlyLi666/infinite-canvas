export default {
    ...
    settingsPanels: {
        ...
        model: {
            ...
            catalog: {
                gptImage2: { name: "GPT-image-2 (Create/Edit)", hint: "Rich detail, good for polished large images" },
                grokImagineImage: { name: "GROK Fast (No Editing)", hint: "Fast and cost-effective" },
                grokImagineImageQuality: { name: "GROK High Quality (No Editing)", hint: "Dedicated high-fidelity model, finer detail" },
                grokImagineEdit: { name: "GROK Edit Only", hint: "Edit from a reference image" },
                grokImagineVideo15: { name: "Grok Video 1.5", hint: "1080p, 1–15s, with audio" },
