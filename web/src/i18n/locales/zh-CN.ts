export default {
    ...
    settingsPanels: {
        ...
        model: {
            ...
            catalog: {
                gptImage2: { name: "GPT-image-2（生图/改图）", hint: "细节丰富，适合精修大图" },
                grokImagineImage: { name: "GROK-快速（不能改图）", hint: "快速出图，性价比高" },
                grokImagineImageQuality: { name: "GROK-高质量（不能改图）", hint: "高保真独立模型，画面更精细" },
                grokImagineEdit: { name: "GROK-改图专用", hint: "基于参考图修改" },
                grokImagineVideo15: { name: "Grok 视频 1.5", hint: "1080p、1-15 秒、自带声音" },
