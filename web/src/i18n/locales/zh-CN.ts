export default {
    ...
    settingsPanels: {
        ...
        model: {
            ...
            catalog: {
                gptImage2: { name: "GPT 生图", hint: "$1/张 · 文字和改图最强" },
                grokImagineImage: { name: "GROK 快速", hint: "先出草稿，快但不精" },
                grokImagineImageQuality: { name: "GROK 写实", hint: "人像更像照片，不能改图" },
                grokImagineImage20: { name: "GROK 2.0", hint: "1K $1 / 2K $1.5 · 会排版会改图" },
                grokImagineEdit: { name: "GROK 旧改图", hint: "旧口，改图请用2.0" },
                grokImagineVideo15: { name: "GROK 视频", hint: "$0.30 / $0.60 / $1 每秒 · 最长15秒" },
                seedance20: { name: "Seedance 2.0", hint: "$4.50 / $9.90 / $24.80 每秒" },
                seedance25: { name: "Seedance 2.5", hint: "$6.70 / $15.10 / $37.70 每秒 · 最长30秒" },
