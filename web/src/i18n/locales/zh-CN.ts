export default {
    ...
    common: {
        ...
        download: "下载",
        downloadFailed: "下载失败",
        downloadRemoteOpened: "已在新标签打开。如果仍是黑屏，说明当前网络到不了成片地址。",
        upload: "上传",
        requestCanceled: "请求已取消",
        durationMinutes: "{{minutes}}分{{seconds}}秒",
        durationSeconds: "{{seconds}}秒",
        imageReadFailed: "读取图片失败",
        localDataNotice: "图片、视频和画布只保存在当前浏览器。请及时下载需要保留的内容。更换设备或清理缓存后，本地数据都会消失。",
    },
    settingsPanels: {
        ...
        model: {
            ...
            catalog: {
                gptImage2: { name: "GPT 生图", hint: "$2.3/张 · 文字和改图最强" },
                grokImagineImage: { name: "GROK 快速", hint: "先出草稿，快但不精" },
                grokImagineImageQuality: { name: "GROK 写实", hint: "人像更像照片，不能改图" },
                grokImagineImage20: { name: "GROK 2.0", hint: "1K $1.2 / 2K $2.2 · 会排版会改图" },
                grokImagineEdit: { name: "GROK 旧改图", hint: "旧口，改图请用2.0" },
                grokImagineVideo15: { name: "GROK 视频", hint: "低 $0.6 · 中 $0.8 · 高 $1.5 /秒 · 最长15秒" },
                seedance20: { name: "Seedance 2.0", hint: "低 $4.50 · 中 $9.90 · 高 $24.80 /秒" },
                seedance25: { name: "Seedance 2.5", hint: "低 $6.70 · 中 $15.10 · 高 $37.70 /秒 · 最长30秒" },
                grok46: { name: "GROK 4.6", hint: "聊天推理，更强更新" },
                gpt56Sol: { name: "Sol", hint: "文本创作，均衡稳妥" },
                gpt56Luna: { name: "Luna", hint: "文本创作，更偏创意" },
                gpt56Terra: { name: "Terra", hint: "文本创作，更偏克制" },
            },
        },
    },
    generation: {
        pending: ["正在创建图片", "马上就好了", "再等等", "正在整理细节"],
        queuedAhead: "排队中，前面还有 {{count}} 张",
        queuedNext: "排队中，下一个就轮到你",
        queuedWaiting: "排队中",
    ...
    auth: {
        title: "研路AI 账号登录",
        subtitle: "登录后自动接入研路AI生图服务，无需手动配置密钥。作品只保存在当前浏览器，请及时下载。",
        login: "登录",
        account: "我的账号",
        email: "邮箱",
        emailRequired: "请输入邮箱",
        ...
        register: "注册研路AI账号",
        forgotPassword: "忘记密码",
        totpHint: "已为 {{email}} 开启两步验证，请输入验证器中的 6 位验证码",
        totpRequired: "请输入 6 位验证码",
        totpSubmit: "验证并登录",
        back: "返回重新输入",
        loginSuccess: "登录成功",
        loggedOut: "已退出登录",
        recharge: "充值",
        logout: "退出登录",
        provisionFailed: "研路AI服务初始化失败，请稍后重试",
        turnstileRequired: "请先完成人机验证",
        turnstileLoadFailed: "人机验证组件加载失败，请检查网络后重试",
        errors: {
            network: "网络异常，请检查网络后重试",
            requestFailed: "请求失败，请稍后重试",
            invalidCredentials: "邮箱或密码错误",
            userNotActive: "账号未激活或已被禁用",
    ...
    apiErrors: { insufficientBalance: "余额不足，去充值", invalidApiKeyRelogin: "登录状态已失效，请重新登录", imageGenerationFailed: "生成失败", tooBusyRetryLater: "服务繁忙，请稍后重试", requestFailed: "请求失败", requestCanceled: "请求已取消", corsRequired: "请求被浏览器跨域策略拦截，请通过自己的服务转发请求", baseUrlRequired: "请先配置 Base URL", apiKeyRequired: "请先配置 API Key", authenticationFailed: "鉴权失败，请检查 API Key、套餐权限或模型权限", rateLimited: "请求被限流或额度不足，请稍后重试", notFound: "接口地址不存在（404），请检查 Base URL 和模型选择", badGateway: "网关错误（502），接口服务暂时不可用，请稍后重试", serviceBusy: "服务繁忙（503），请稍后重试", httpFailed: "请求失败（HTTP {{status}}），请检查 Base URL 和 API Key 是否正确", htmlError: "服务返回了 HTML 错误页面（{{preview}}）", audioModelRequired: "请先配置音频模型", audioGenerationFailed: "音频生成失败", scriptNoAudio: "模型调用脚本没有返回音频", geminiAudioUnsupported: "Gemini 调用格式暂不支持音频生成，请使用 OpenAI 格式渠道", invalidImageSizeFormat: "图像尺寸格式不支持，请使用 auto、9:16 或 1024x1024", positiveImageRatio: "图像比例必须是正数，例如 9:16", imageRatioLimit: "图像宽高比不能超过 3:1，请调整尺寸", positiveImageDimensions: "图像尺寸必须是正整数，例如 1024x1024", imageDimensionStep: "图像尺寸的宽高必须是 16 的倍数，请调整尺寸", imageEdgeLimit: "图像尺寸最长边不能超过 3840px，请调整尺寸", imagePixelLimit: "图像总像素需在 655360 到 8294400 之间，请调整尺寸", unknownImageResponse: "接口返回了未知格式的数据（字段：{{fields}}），请检查模型或接口兼容性", noImageReturned: "接口没有返回图片，请检查提示词是否触发安全审核或模型是否支持该操作", grokEditImageLimit: "GROK 改图最多用 {{max}} 张参考图，已只用前 {{max}} 张", geminiRejected: "Gemini 拒绝了本次请求：{{reason}}", geminiNoImage: "Gemini 接口没有返回图片", geminiMaskUnsupported: "Gemini 调用格式暂不支持蒙版编辑", maskModelUnsupported: "蒙版编辑暂不支持该模型，请使用其他渠道", noContent: "没有返回内容", modelReadFailed: "读取模型失败", videoTimeout: "{{provider}}视频生成超时，请稍后重试", pluginVideoExpired: "插件视频任务已失效，请重新生成", scriptNoVideo: "模型调用脚本没有返回视频", noPlayableVideo: "视频接口没有返回可播放的视频", noVideoTaskId: "视频接口没有返回任务 ID", videoTaskCreateFailed: "视频任务创建失败", videoGenerationFailed: "视频生成失败", videoTaskQueryFailed: "视频任务查询失败", videoPromptRequired: "请输入视频提示词，或连接参考图片/视频/音频", referenceImageReadFailed: "参考图读取失败，请换一张图片或重新上传", invalidReferenceVideo: "参考视频必须是公网 URL、资产 ID，或本地已保存的视频", invalidReferenceAudio: "参考音频必须是公网 URL、资产 ID，或本地已保存的音频", videoModelRequired: "请先配置视频模型", geminiVideoUnsupported: "Gemini 调用格式暂不支持视频生成，请使用 OpenAI 格式渠道", noVideoTask: "接口没有返回视频任务", videoDownloadFailed: "视频下载失败", mediaUnreachable: "成片已经生成，但当前网络打不开境外地址，从近节点取回也失败了。请稍后重试，或联系客服从流水找回。", localAssetReadFailed: "读取本地资产失败" },
    prompts: {
        title: "提示词中心",
        library: "提示词库",
    ...
    assets: {
        title: "我的资产",
        description: "收藏常用文本和图片，按类型、标题和标签快速查找。资产只存在当前浏览器，请及时导出或下载需要保留的内容。",
    ...
    canvas: {
        ...
        node: {
            node: "节点",
            untitled: "未命名节点", renameHint: "双击修改节点名称", group: "组", nodeCount: "{{count}} 个节点", generating: "生成中", failed: "生成失败", retry: "重试", missingPlugin: "缺少插件", missingPluginDescription: "节点类型“{{type}}”的插件未安装或未启用", generateImage: "用文本生图", generate: "生图", editText: "双击编辑文字", emptyImage: "空图片节点", emptyVideo: "空视频节点", emptyAudio: "空音频节点", videoUnplayable: "视频地址打不开", openVideo: "在新标签查看", audio: "音频", batchExpanded: "图片组已展开", batchCollapsed: "图片组已收起", createCopy: "创建副本", setPrimary: "设为主图",
        },
        sidePanel: {
    ...
    home: {
        promptError: "获取提示词失败",
        description: "在 <canvas>RIGEL</canvas> 中生成、连接和重组 <content>图片、文字与图形</content>，让创作从单次生成变成连续推演。",
        start: "开始使用",
        openCanvas: "打开画布",
    ...
    config: {
        ...
        description: "研路AI服务、默认模型、同步与本地存储",
        modalDescription: "研路AI服务、默认模型、同步与本地存储",
        tabs: {
            channels: "渠道",
            preferences: "偏好设置",
            promptSources: "提示词来源",
        ...
        channels: {
            description: "登录研路AI后自动使用托管服务，无需填写接口地址或密钥。",
            add: "新增渠道",
            unnamed: "未命名渠道",
            ...
            managedDescription: "研路AI账号自动管理",
            signInHint: "登录研路AI账号后即可使用生图、视频和文本，无需自行添加渠道。",
        },
        preferences: {
            interface: "界面偏好",
            language: "界面语言",
        ...
        channelEditor: {
            ...
            name: "渠道名称",
            protocol: "协议",
            managedHint: "该渠道由研路AI账号自动管理，接口地址和密钥无需配置。",
            baseUrl: "接口地址",
            models: "渠道模型",
