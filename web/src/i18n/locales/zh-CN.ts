export default {
    ...
    settingsPanels: {
        ...
        model: {
            ...
            catalog: {
                gptImage2: { name: "GPT 生图", hint: "文字和改图最强" },
                grokImagineImage: { name: "GROK 快速", hint: "先出草稿，快但不精" },
                grokImagineImageQuality: { name: "GROK 写实", hint: "人像更像照片，不能改图" },
                grokImagineImage20: { name: "GROK 2.0", hint: "会排版会改图，GROK首选" },
                grokImagineEdit: { name: "GROK 旧改图", hint: "旧口，改图请用2.0" },
                grokImagineVideo15: { name: "GROK 视频", hint: "1.5正式版，最长15秒，可带声音" },
                seedance20: { name: "Seedance 2.0", hint: "短片稳，画质更熟" },
                seedance25: { name: "Seedance 2.5", hint: "更长更会参考，最长30秒" },
