export default {
    ...
    settingsPanels: {
        ...
        model: {
            ...
            catalog: {
                gptImage2: { name: "GPT 生图 2", hint: "细节丰富，适合精修大图" },
                grokImagineImage: { name: "Grok 生图", hint: "快速出图，性价比高" },
                grokImagineImageQuality: { name: "Grok 高质量图", hint: "高保真独立模型，画面更精细" },
                grokImagineEdit: { name: "Grok 改图", hint: "基于参考图修改" },
