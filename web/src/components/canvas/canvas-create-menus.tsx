...
import { ImageIcon, List, Settings2, Video, X } from "lucide-react";
...
export function ConnectionCreateMenu({
    ...
    onCreate: (type: CanvasNodeType.Image | CanvasNodeType.Text | CanvasNodeType.Config | CanvasNodeType.Video) => void;
    onClose: () => void;
}) {
