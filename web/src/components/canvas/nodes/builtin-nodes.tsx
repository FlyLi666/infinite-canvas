...
const BUILTIN_DEFINITIONS: CanvasNodeDefinition[] = [
    ...
    { type: CanvasNodeType.Audio, title: i18n.t("assets.kinds.audio"), icon: <Music2 className={iconClass} />, minimapColor: "#a855f7", resource: builtinResource, showInCreateMenu: false, hidePanel: true },
