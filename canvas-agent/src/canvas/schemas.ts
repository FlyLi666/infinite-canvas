...
const nodeTypeSchema = z.enum(["image", "text", "config", "video"]);
...
export const toolDescriptions: Record<ToolName, string> = {
    ...
    canvas_create_node: "创建任意类型节点：text、image、config、video。适合创建占位图、媒体占位、配置节点或自定义 metadata 节点。",
    ...
    canvas_run_generation: "触发指定节点生成，通常用于配置节点或文本/图片/视频节点。",
